...
- **Refonte cible — onglets/projections + base immuable (R1/R2, arbitrée 2026-09-09)** :
  ...
  ✅ **R1-a et R1-b LIVRÉS** (deux conversations distinctes) : R1-a `245071b` = onglets hybrides + projection par phase (rendu SEUL, stockage intact) ; R1-b `c911547` = stockage par phase + fin de `CorrectionFusionnee` — le handoff « État du code À LA FIN de R1-a » du plan est CONSOMMÉ.
